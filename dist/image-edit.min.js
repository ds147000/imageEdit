    ...
    var Scenes = /** @class */ (function () {
        ...
        Scenes.prototype.onTouchMoveImage = function (event) {
            if (this.downType === 0)
                ...
                var oldEvent = { offsetX: this.oldTouchs[0].pageX, offsetY: this.oldTouchs[0].pageY };
                var _a = getMove({ offsetX: event.pageX, offsetY: event.pageY }, oldEvent), x = _a.x, y = _a.y;
                this.moveImage(this.oldImageSize.x + x * this.scale, this.oldImageSize.y + y * this.scale);
            }
        };
        ...
        Scenes.prototype.resDrwaImage = function () {
            ...
            if (this.imageSize.zoom !== 1 || this.imageSize.rotate !== 0) { // 存在旋转和放大
                var imageRadiusWideh = this.imageSize.width / 2;
                var imageRadiusHeight = this.imageSize.height / 2;
